...
\paragraph[{dnrm2(double $\ast$v, int n)}]{\setlength{\rightskip}{0pt plus 5cm}double dnrm2 (
...
\paragraph[{projection\+On\+Cone(double $\ast$r, double mu)}]{\setlength{\rightskip}{0pt plus 5cm}void projection\+On\+Cone (
\begin{DoxyParamCaption}
\item[{double $\ast$}]{r, }
\item[{double}]{mu}
\end{DoxyParamCaption}
